...
@section('content')
        <div>
            <h1>Add event page for Resource Person.</h1>
        </div>
        {!!Form::open(['action'=>'EventController@store','method'=>'POST'])!!}
            ...
            <div class="form-group">
                ...
                {{Form::text('venue','',['class'=>'form-control','placeholder'=>'Enter Venue'])}}
            </div>

            <div class="form-group">
                {{Form::label('date','Date')}}
                {{Form::date('date','',['class'=>'form-control','placeholder'=>'Select Date'])}}
            </div>

            <div class="form-group">
                {{Form::label('startTime','Start Time')}}
                {{Form::time('startTime','',['class'=>'form-control','placeholder'=>'Select Time'])}}
            </div>

            <div class="form-group">
                {{Form::label('endTime','End Time')}}
                {{Form::time('endTime','',['class'=>'form-control','placeholder'=>'Select Time'])}}
            </div>
